...
import { Leaf, Eye, EyeOff, ArrowRight, Loader2, User, ArrowLeft } from 'lucide-react'
      ...
      <div style={{ width: '100%', maxWidth: '440px', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ 
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-300">Create Password</label>
              <div className="relative">
                <input
                  id="password"
                  name="password"
            ...
            <button 
              ...
              disabled={isPending} 
            >
              {isPending ? <><Loader2 size={18} className="animate-spin" /> Processing...</> : <>Create Account <ArrowRight size={18} /></>}
            </button>
          </form>
