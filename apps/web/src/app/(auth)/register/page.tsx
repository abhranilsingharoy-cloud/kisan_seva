...
import { Leaf, Phone, Eye, EyeOff, ArrowRight, Loader2, User, ArrowLeft } from 'lucide-react'
...
export default function RegisterPage() {
  ...
  return (
    <div style={{ 
      ...
      <div style={{ position: 'absolute', top: '-10%', right: '-5%', width: '400px', height: '400px', background: 'rgba(52, 211, 153, 0.15)', filter: 'blur(80px)', borderRadius: '50%' }} />
      <div style={{ position: 'absolute', bottom: '-10%', left: '-5%', width: '400px', height: '400px', background: 'rgba(16, 185, 129, 0.15)', filter: 'blur(80px)', borderRadius: '50%' }} />
      ...
      <div style={{ width: '100%', maxWidth: '440px', position: 'relative', zIndex: 10 }}>
        ...
        <div className="text-center mb-8">
          ...
          <div className="mb-2 uppercase tracking-widest text-xs font-bold" style={{ color: '#6ee7b7' }}>
            {step === 'otp' ? 'Verify Mobile' : 'Join the Community'}
          </div>
          ...
          {step === 'details' ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label htmlFor="name-input" className="block mb-2 text-sm font-medium text-gray-300">Full Name</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      style={{ background: 'rgba(0,0,0,0.2)', border: '1px solid rgba(255,255,255,0.1)', fontSize: '1.05rem', paddingLeft: '44px' }}
                ...
                <div>
                  <label htmlFor="password-input" className="block mb-2 text-sm font-medium text-gray-300">Create Password</label>
                  <div className="relative">
                    <input
                      id="password-input"
                ...
                <button 
                  ...
                  disabled={loading} 
                >
                  {loading ? <><Loader2 size={18} className="animate-spin" /> Processing...</> : method === 'phone' ? <><Phone size={18} /> Send Verification OTP</> : <>Create Account <ArrowRight size={18} /></>}
                </button>
              </form>
            </>
          ) : (
