...
export default function SettingsProfilePage() {
  ...
  // Load from local storage or supabase if we wanted
  useEffect(() => {
    ...
    <div className="max-w-4xl mx-auto p-4 md:p-6 lg:p-8 space-y-6 pb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-center gap-6">
                  <div className="relative">
                    <div className="w-24 h-24 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 text-3xl font-bold border-4 border-white shadow-md">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 font-medium">{profile.farmLocation}</p>
        ...
        <div className="space-y-4">
          ...
          <button className="w-full flex items-center justify-center gap-2 p-4 bg-red-50 hover:bg-red-100 text-red-600 rounded-2xl text-sm font-bold transition-colors">
